...
const Reviews = () => {
    ...
    return (
        <div className="w-full min-h-screen p-6 md:p-12 relative overflow-hidden">
            <div className="absolute bottom-0 left-0 w-full h-3 bg-gradient-to-t from-white/80 to-transparent z-10 pointer-events-none" />
            ...
            <div className="absolute inset-0 z-0">
                {Array.from({ length: 8 }).map((_, i) => (
                    <motion.div
                        ...
                        style={{ width: '100%', top: `${10 + i * 12}%`, left: 0 }}
                ...
                {Array.from({ length: 8 }).map((_, i) => (
                    <motion.div
                        ...
                        style={{ height: '100%', left: `${10 + i * 12}%`, top: 0 }}
